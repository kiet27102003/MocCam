...
import VirtualDanTranh from "./pages/DanTranh/VirtualDanTranh/VirtualDanTranh"; // Đảm bảo đã import
    ...
    <ThemeProvider theme={theme}>
      <RoleProvider>
        ...
        <Routes>
          ...
          {/* ======================= DÒNG CODE ĐÃ THAY ĐỔI/THÊM VÀO ======================= */}
          {/* Tôi đã sửa lại đường dẫn này để khớp với đường dẫn bạn có sẵn */}
